...
public class Point implements Comparable<Point> {
	...
	public double slopeTo(Point that) {
		...
		if (this.y == that.y)
			return +0.0; // treat horizontal line with slope positive 0
	...
	public static void main(String[] args) {
		// Point pt_1_1 = new Point(1, 1);
		// Point pt_2_2 = new Point(2, 2);
		// Point pt_5_1 = new Point(5, 1);
		// Point pt_1_5 = new Point(1, 5);
		// System.out.println(pt_1_1.slopeTo(pt_1_5));
		// System.out.println(pt_1_1.compareTo(new Point(1, 0)));
	}
}